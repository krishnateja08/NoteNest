...
.notes-folder-list{flex:1;overflow-y:auto;padding:6px 0;scrollbar-width:thin;scrollbar-color:var(--border) transparent}
...
.notes-list-items{flex:1;overflow-y:auto;scrollbar-width:thin;scrollbar-color:var(--border) transparent}
.notes-list-items::-webkit-scrollbar{width:4px}
.notes-list-items::-webkit-scrollbar-track{background:transparent}
.notes-list-items::-webkit-scrollbar-thumb{background:var(--border);border-radius:4px}
.notes-list-items::-webkit-scrollbar-thumb:hover{background:var(--border2)}
.notes-list-item{
