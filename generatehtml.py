...
<div class="settings-modal">
  ...
  <div id="enc-key-section" style="display:none">
    <div class="frow">
      ...
      <div style="display:flex;gap:6px">
        <input id="cfg-enc-key" type="password" readonly placeholder="No key yet" style="flex:1;font-family:monospace;font-size:12px">
    ...
    <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:8px">
      ...
      <button class="btn-ghost" onclick="document.getElementById('enc-key-import').click()" style="font-size:12px">📥 Import Key</button>
      <button class="btn-ghost" onclick="exportEncKey()" style="font-size:12px">📤 Export Key</button>
