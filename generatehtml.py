...
.notes-list-items{flex:1;overflow-y:auto;scrollbar-width:none}
...
<div class="main">
  ...
  <div id="page-notes" style="display:none;flex-direction:row;height:calc(100vh - 58px);align-items:stretch">
    <div class="notes-page-wrap" style="width:100%;height:100%;align-items:stretch">
